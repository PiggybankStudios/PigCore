...
void AppInit(void)
{
	...
	testTexture = InitTexture(stdHeap, StrLit("testTexture"), testTextureData.size, testTextureData.pixels, TextureFlag_Mutable|TextureFlag_HasCopy|TextureFlag_NoMipmaps);
