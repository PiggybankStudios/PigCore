...
/*
    ...
    Cmdline:
        sokol-shdc --format=sokol_impl --errfmt=msvc --slang=hlsl5:glsl430:glsl300es:metal_macos --input=..\\tests\\simple_shader.glsl --output=..\\tests\\simple_shader.glsl.h
...
#endif
#define simple_SHADER_FILE_PATH "C:/gamedev/projects/PigCore/tests/simple_shader.glsl"
