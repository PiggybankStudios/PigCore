...
#define DrawSheetCell(sheet, cellPos, rectangle, color)                                                                                                  GfxSystem_DrawSheetCell(&gfx, (sheet), (cellPos), (rectangle), (color))
#define DrawNamedSheetCell(sheet, cellName, rectangle, color)                                                                                            GfxSystem_DrawNamedSheetCell(&gfx, (sheet), (cellName), (rectangle), (color))
