...
PEXP void InitGfxSystem(Arena* arena, GfxSystem* systemOut)
{
	...
	for (uxx tIndex = 0; tIndex < GFX_SYSTEM_RING_NUM_THICKNESSES; tIndex++)
	{
		...
		for (uxx sIndex = 0; sIndex < GFX_SYSTEM_RING_NUM_SIDES; sIndex++)
		{
			...
			v2 positionAndTexCoordInner0 = MakeV2(0.5f + CosR32(angle0)*innerRadius, 0.5f + SinR32(angle0)*innerRadius);
...
PEXPI void GfxSystem_DisableClipRec(GfxSystem* system) { GfxSystem_SetClipRec(system, MakeReciV(V2i_Zero, system->screenSize)); }
...
{
	GfxSystem_DrawTexturedRectangleEx(system, rectangle, color, nullptr, Rec_Zero);
}
...
{
	GfxSystem_DrawTexturedRectangleOutlineSidesEx(system, rectangle, leftThickness, rightThickness, topThickness, bottomThickness, color, outside, nullptr, Rec_Zero);
}
...
{
	GfxSystem_DrawTexturedRectangleOutlineSidesEx(system, rectangle, leftThickness, rightThickness, topThickness, bottomThickness, color, true, nullptr, Rec_Zero);
}
...
{
	GfxSystem_DrawTexturedRectangleOutlineSidesEx(system, rectangle, borderThickness, borderThickness, borderThickness, borderThickness, color, outside, nullptr, Rec_Zero);
}
PEXPI void GfxSystem_DrawRectangleOutline(GfxSystem* system, rec rectangle, r32 borderThickness, Color32 color)
{
	GfxSystem_DrawTexturedRectangleOutlineSidesEx(system, rectangle, borderThickness, borderThickness, borderThickness, borderThickness, color, true, nullptr, Rec_Zero);
}
...
{
	GfxSystem_DrawTexturedCirclePieceEx(system, circle, angleMin, angleMax, color, nullptr, Rec_Zero);
}
PEXPI void GfxSystem_DrawCircle(GfxSystem* system, Circle circle, Color32 color)
{
	GfxSystem_DrawTexturedCirclePieceEx(system, circle, 0, TwoPi32-DEFAULT_R32_TOLERANCE, color, nullptr, Rec_Zero);
}
...
{
	GfxSystem_DrawTexturedRoundedRectangleEx(system, rectangle, radiusTL, radiusTR, radiusBR, radiusBL, color, nullptr, Rec_Zero);
}
PEXPI void GfxSystem_DrawRoundedRectangle(GfxSystem* system, rec rectangle, r32 radius, Color32 color)
{
	GfxSystem_DrawTexturedRoundedRectangleEx(system, rectangle, radius, radius, radius, radius, color, nullptr, Rec_Zero);
}
...
{
	GfxSystem_DrawTexturedRingPieceEx(system, circle, thickness, angleMin, angleMax, color, nullptr, Rec_Zero);
}
PEXPI void GfxSystem_DrawRing(GfxSystem* system, Circle circle, r32 thickness, Color32 color)
{
	GfxSystem_DrawTexturedRingPieceEx(system, circle, thickness, 0, TwoPi32-DEFAULT_R32_TOLERANCE, color, nullptr, Rec_Zero);
}
...
{
	GfxSystem_DrawTexturedRoundedRectangleOutlineEx(system, rectangle, thickness, radiusTL, radiusTR, radiusBR, radiusBL, color, outside, nullptr, Rec_Zero);
}
PEXPI void GfxSystem_DrawRoundedRectangleOutline(GfxSystem* system, rec rectangle, r32 thickness, r32 radius, Color32 color)
{
	GfxSystem_DrawTexturedRoundedRectangleOutlineEx(system, rectangle, thickness, radius, radius, radius, radius, color, true, nullptr, Rec_Zero);
}
...
PEXPI void GfxSystem_ClearDepthBuffer(GfxSystem* system, r32 clearDepth)
{
	...
	GfxSystem_DrawRectangle(system, Rec_UnitRec, MonokaiPurple);
...
FONT_FLOW_DRAW_CHAR_DEF(GfxSystem_FontFlowDrawCharCallback)
{
	...
	rec atlasSourceRec = ToRecFromi(MakeReciV(glyph->atlasSourcePos, glyph->metrics.glyphSize));
