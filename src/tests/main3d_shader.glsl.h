...
/*
    ...
    Cmdline:
        sokol-shdc --format=sokol_impl --errfmt=msvc --slang=hlsl5:glsl430:glsl300es:metal_macos --input=..\\src\\tests\\main3d_shader.glsl --output=..\\src\\tests\\main3d_shader.glsl.h
...
#endif
#define main3d_SHADER_FILE_PATH "C:/gamedev/projects/PigCore/src/tests/main3d_shader.glsl"
