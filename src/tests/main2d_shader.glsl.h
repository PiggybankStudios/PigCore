...
/*
    ...
    Cmdline:
        sokol-shdc --format=sokol_impl --errfmt=msvc --slang=hlsl5:glsl430:glsl300es:metal_macos --input=..\\src\\tests\\main2d_shader.glsl --output=..\\src\\tests\\main2d_shader.glsl.h
...
#endif
#define main2d_SHADER_FILE_PATH "C:/gamedev/projects/PigCore/src/tests/main2d_shader.glsl"
